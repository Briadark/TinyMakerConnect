...
const TINYMAKER_CONNECT_VERSION = '0.2.3';
...
function model_to_api(array $row): array
{
    return [
        ...
        'preview_05_url' => ($row['preview_05_path'] ?? null) ? '/preview.php?id=' . rawurlencode($row['public_id']) . '&type=05' : null,
        'preview_1_url' => ($row['preview_1_path'] ?? null) ? '/preview.php?id=' . rawurlencode($row['public_id']) . '&type=1' : null,
